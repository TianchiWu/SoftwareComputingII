<template>
    ...
    >
        <a-form :form="form" style="margin-top: 30px">
            <a-form-item label="酒店名称" :label-col="{ span: 4 }" :wrapper-col="{ span: 8, offset: 1 }">
                <a-input
                        placeholder="请填写酒店名称"
            ...
            <a-form-item label="地址" :label-col="{ span: 4 }" :wrapper-col="{ span: 8, offset: 1 }">
                <a-input
                        placeholder="请填写地址"
            ...
            <a-form-item label="星级" :label-col="{ span: 4 }" :wrapper-col="{ span: 8, offset: 1 }">
                <a-select
                        v-decorator="[
                    'hotelStar',
            ...
            <a-form-item label="联系电话" :label-col="{ span: 4 }" :wrapper-col="{ span: 8, offset: 1 }">
                <a-input
                        placeholder="请填写联系电话"
                        v-decorator="['phoneNum', { rules: [{required: true,  message: '请输入联系电话' },{ validator: this.phoneCheck}] }]"
                        v-if="modify"
                />
                <span v-else>{{ updateHotelInfo.phoneNum}}</span>
            </a-form-item>
            <a-form-item label="描述" :label-col="{ span: 4 }" :wrapper-col="{ span: 8, offset: 1 }">
                <a-input
                        placeholder="请填写酒店描述"
                        type="textarea"
                        :rows="4"
            ...
            <a-form-item label="详情" :label-col="{ span: 4 }" :wrapper-col="{ span: 8, offset: 1 }">
                <a-input
                        placeholder="请填写酒店详情"
                        type="textarea"
                        :rows="10"
