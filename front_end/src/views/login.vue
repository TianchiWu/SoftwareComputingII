        ...
        <a-tab-pane key="tab2" tab="注册新账号">
          <a-form-item>
            <a-input
              ...
              v-decorator="[
              'registerUserMail', 
              {rules: [{ required: true, type: 'email', message: '请输入邮箱' },{ validator: this.checkEmail }], validateTrigger: 'blur'}]">
          ...
          <a-form-item>
            <a-input
                    ...
                    v-decorator="[
              'birthday',
              {rules: [{ required: true, message: '请输入生日' }], validateTrigger: 'blur'}]">
              <a-icon slot="prefix" type="user" :style="{ color: 'rgba(0,0,0,.25)' }"/>
            </a-input>
          </a-form-item>
           <a-form-item style="margin-top:24px">
...
export default {
  ...
  methods: {
    ...
    handlelogin() {
      const validateFieldsKey = this.customActiveKey === 'tab1' ? ['username', 'password'] : ['registerUserName', 'registerUserMail','registerPassword','registerPasswordconfirm','birthday']
    ...
    handleRegister() {
      ...
      const validateFieldsKey = this.customActiveKey === 'tab1' ? ['username', 'password'] : ['registerUserName','registerPhoneNumber','registerUserMail','registerPassword','registerPasswordconfirm','birthday']
